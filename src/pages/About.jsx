    ...
    return (
        <>
            ...
            <section className="relative">
                <div
                    className="absolute left-1/2 -top-[300px] w-full h-[550px] -translate-x-1/2 bg-cover  bg-[url('https://aplio.vercel.app/images/hero-gradient.png')] bg-no-repeat bg-center opacity-70 md:hidden -z-10"
                ></div>
                <div className="container relative ">
                    ...
                    <div className="grid grid-cols-3 max-md:grid-cols-1 gap-10 items-center  max-md:mb-25 mb-[160px]">
                        ...
                        >
                            <img
                                src="https://www.bboxx.com/wp-content/uploads/MicrosoftTeams-image-17.jpg"
                                alt="about images"
                    ...
                    <div className="grid grid-cols-12">
                        <div className="max-md:col-span-full md:col-span-6">
                            <div className="max-w-[550px]">
                                ...
                                <h2>
                                    Connect with Your Clients Effortlessly
                                </h2>
                            </div>
                        </div>
            ...
            <section class="relative max-md:overflow-hidden max-md:py-25 py-150">
                <div
                    class="absolute left-0 right-0 top-25 bg-[url('https://aplio.vercel.app/images/core-gradient.png')] bg-no-repeat bg-center opacity-70 w-full h-full bg-[length:600px_1000px] md:hidden"
                ></div>
                <div class="container ">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class=" grid grid-cols-3 max-md:grid-cols-1 gap-8">
                            <div class="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5">
                                <div
                                    class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark p-10 max-lg:p-5 text-center h-full"
                                >
                                    <img
                                        src="https://aplio.vercel.app/images/about/passion.svg"
                                        alt="value image"
                            ...
                            <div class="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5 ">
                                ...
                                >
                                    <img
                                        src="https://aplio.vercel.app/images/about/transparency.svg"
                                        alt="value image"
                                        class="inline-block dark:hidden mb-6"
                                    />
                            ...
                            <div class="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5">
                                ...
                                >
                                    <img
                                        src="https://aplio.vercel.app/images/about/mission.svg"
                                        alt="value image"
                                        class="inline-block dark:hidden mb-6"
                                    />
            ...
            <section className=" overflow-hidden relative pb-150  max-md:pb-25 ">
                <div className="container relative z-10">
                    <div className="grid grid-cols-2 max-md:grid-cols-1 gap-10 1xl:gap-x-24 items-center">
                        <div className="relative flex max-md:justify-center justify-end items-center">
                            <img
                                src="https://aplio.vercel.app/images/about/onlinePayment.png"
                                alt="banking image"
                            ...
                            >
                                <img
                                    src="https://aplio.vercel.app/images/about/onlinePayment-shape.png"
                                    alt="banking image"
                                    className="dark:hidden"
                                />
                            </div>

                            <div className="absolute left-0 right-auto bottom-8 top-auto max-w-[180px] md:max-w-[250px] xl:max-w-[344px]"></div>
                        </div>

                        <div>
                            <p className="section-tagline">Core Value</p>

                            <h2 className="max-md:mb-4 mb-8">Our guiding principles that drive Peleka's mission to deliver excellence.</h2>
                            <p className="max-md:mb-6 mb-11">
                                Peleka enables local businesses to scale by offering accessible and reliable delivery services that meet their needs.
                            </p>
                            <ul className="max-md:mb-0 mb-14 [&>*:not(:last-child)]:mb-6 max-md:[&>*:not(:last-child)]:mb-4">
                                <li className="flex items-center gap-x-2 ">
                                    ...
                                    >
                                        ...
                                        >
                                            <circle
                                                ...
                                                r="14"
                                                fill=""
                                                className="fill-[#4379F2] dark:fill-[#3B3C39]"
                                            />
                                            <path
                                    ...
                                    <span className="dark:text-white"> Customer-Centric Service </span>
                                </li>
                                <li className="flex items-center gap-x-2">
                                    ...
                                    <span className="dark:text-white"> Reliable Delivery Solutions </span>
                                </li>
                                <li className="flex items-center gap-x-2 ">
                                    <span className=" relative  rounded-full bg-white dark:bg-dark-200 shadow-icon flex item-center justify-center">
                                        <svg
                                    ...
                                    <span className="dark:text-white"> Trust and Transparency </span>
                                </li>
                            </ul>
                        </div>
                    </div>
